            ...
            <div class="container">
                  ...
                  <div class="col-lg-12">
                     <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                           ...
                           <img style="height:100px;" src="<?=BASEURL?>assets/images/updated-logo.jpg" alt="" height="90">
                           </a>
                        </div>
               ...
               <div class="row justify-content-center">
                  <div class="col-md-8 col-lg-8 col-xl-5">
                     <div class="card forget-pwd-card mt-0">
                        <div class="card-body p-4 pb-0">
                           <div class="text-center mt-2">
                              <h5  class="text-primary">Forgot Password?</h5>
                              <p class="text-white">Reset password with Square Markets</p>
                              <lord-icon src="https://cdn.lordicon.com/rhvddzym.json" trigger="loop" colors="primary:#ff0000;" class="avatar-xl">
                              </lord-icon>
                           </div>
                           ...
                           <div class="p-2">
                              <form method="post" action="<?=BASEURL?>user/send_otp">
                                  <div class="row">
                                 ...
                                 <div class="text-center mt-4">
                                    <button type="submit" class="btn submit-btn btn-success w-50"><i class="fa-regular fa-circle-check me-2"></i>Submit</button>
                                 </div>
                              </form>
                     ...
                     <div class="mt-0 text-center">
                        <p class="mb-0 text-white">Wait, I remember my password... <a href="<?=BASEURL?>user" class="fw-semibold text-primary text-decoration-underline"> Click here </a> </p>
                     </div>
                  </div>
               </div>
               <!-- end row -->
