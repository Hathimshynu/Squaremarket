...
<div class="row">
   <div class="col-xxl-12 col-lg-12">
      ...
      <h5 class="mb-3">Withdrawal</h5>
       <div class="new">
    <a href="<?=BASEURL?>user/wallet_withdraw_history" id="walletButton" class="btn btn-green fs-25 text-white" style="display: none;">
  <i class="fas fa-eye me-1"></i> Wallet Withdrawal History
</a>

<a href="<?=BASEURL?>user/meta_withdraw_history" id="metaButton" class="btn btn-green fs-25 text-white" style="display: none;">
  <i class="fas fa-eye me-1"></i> Meta Withdrawal History
</a>
      ...
      <div class="card withdraw-card">
         <div class="card-body withdraw-cardbody">
            <ul class="nav nav-pills nav-pills-withdraw nav-justified mb-0" role="tablist" id="withdraw-pills">
               <li class="nav-item withdraw-tab waves-effect waves-light me-3">
                  <a class="nav-link active withdraw-tab-text Wallet withdraw-nav" data-bs-toggle="tab" href="#manual-withdrawl" role="tab">
                  Wallet Withdrawal
                  </a>
               </li>
                <li class="nav-item withdraw-tab waves-effect waves-light">
                   <a class="nav-link withdraw-tab-text Meta withdraw-nav" data-bs-toggle="tab" href="#mt5withdraw" role="tab">
                       Meta Withdrawal
                   </a>
               </li>
            </ul>
               ...
               <div class="tab-pane active" id="manual-withdrawl" role="tabpanel">
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div class="card withdraw-card mt-0 mt-lg-3">
                           <div class="card-header mt-3 withdraw-card withdraw-card-header align-items-center justify-content-between d-flex d-lg-flex d-md-flex d-xl-flex d-xxl-flex">
                              <h4 class="card-title mb-0 flex-grow-1 ww-heading">Wallet Withdrawal</h4>
                              <h4 class="card-title mb-0 flex-grow-1 mt-3 mt-sm-3 mt-md-0 mt-lg-0 mt-xl-0 mt-xxl-0"><span class="">Balance:</span> <span style="letter-spacing:1px;" class="badge balance-badge p-2"><span class="me-1">$</span><?=$wallet;?></span></h4>
                              <!--<a href="<?=BASEURL?>user/wallet_withdraw_history" class="mt-3 mt-sm-3 mt-md-0 mt-lg-0 mt-xl-0 mt-xxl-0 w-history-btn btn btn-green fs-25 text-white">-->
                              <!--                                  <i class="fas fa-eye me-1"></i> Wallet Withdrawal History-->
                              <!--                              </a>-->
                           </div>
  ...
  <!--</div>-->
                           <!-- end card header -->
                           <div class="card-body withdraw-card-body">
                              <div class="live-preview">
                                 <div class="row gy-4">
                                    <div class="col-lg-6">
                                       <form action="<?=BASEURL?>user/withdraw" method="post" id="hockey"> 
                                       <div style="font-weight: 500;" id="message-div" class="text-warning text-center  fs-16"></div>
                                       <div class="row">
               ...
               <div class="tab-pane" id="mt5withdraw" role="tabpanel">
                    <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div class="card withdraw-card mt-0 mt-lg-3">
                           <div class="card-header mt-3 withdraw-card align-items-center justify-content-between d-flex d-lg-flex d-md-flex d-xl-flex d-xxl-flex">
                              <h4 class="card-title mb-0 flex-grow-1">Meta Withdrawal</h4>
                                <!--<a href="<?=BASEURL?>user/meta_withdraw_history" class="w-history-btn btn btn-green fs-25 text-white">-->
                                <!--                                <i class="fas fa-eye me-1"></i> Meta Withdrawal History-->
                                <!--                            </a>-->
                           </div>
                           <!-- end card header -->
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-xxl-12 col-md-12 mb-3">
                                             <?php $accounts = $this->db->where('user_id',$this->session->userdata('usquareusername'))->get('accounts')->result_array(); ?> 
                                                ...
                                                <label for="tid" class="form-label">Account ID <span><?=form_error('hids_id');?></span></label>
                                                ...
                                                <label>Current Balance: <span id="mtbalance"></span></label>
                                          ...
                                          <div class="col-xxl-12 col-md-12 mb-3">
                                             <label for="tid" class="form-label">Amount <span><?=form_error('withdraw_amount');?></span></label>
                                             <div class="input-group">
                                                <span style="font-weight:900;background-color:#20604f;" class="input-group-text input-usd text-white">$</span>
...
<script>
 ...
 $(document).ready(function () {
  ...
  $( "#my-select" ).on( "change", function() {
    var account_id=$('#my-select').val();
   //alert(account_id);
    $.post('<?=BASEURL?>user/get_meta_balance', {
...
<script>
  const walletTab = document.querySelector(".withdraw-tab-text.Wallet.withdraw-nav");
  const metaTab = document.querySelector(".withdraw-tab-text.Meta.withdraw-nav");
  ...
  function handleTabChange() {
    ...
    } else if (metaTab.classList.contains("active")) {
      walletButton.style.display = "none";
      metaButton.style.display = "inline-block";
    }
  }

  // Add event listener for tab change
  walletTab.addEventListener("click", handleTabChange);
  metaTab.addEventListener("click", handleTabChange);

  // Call the initial tab change handler
  handleTabChange();
</script>
