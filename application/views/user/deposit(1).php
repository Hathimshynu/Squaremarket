                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        ...
                                                        <!-- end card header -->
                                                         ...
                                                         <form action="<?=BASEURL?>user/deposit" role="form" method="post" enctype='multipart/form-data' id="hockey">
                                                            ...
                                                            <div class="live-preview">
                                                                <div class="row gy-4">
                                                                   ...
                                                                   <div id="error" class="text-center text-danger currency-error"></div>
                                                                     ...
                                                                     <select class="form-select select-currency"  id="currency" name="currency">
                                                                   ...
                                                                   <div style="background-color:#20604f;" class="input-group">
                                                                    ...
                                                                    <div class="col-xxl-12 col-md-12 mb-3 mt-1">
                                                                        <div>
                                                                            <label for="formFile" class="form-label">Upload Reciept</label>
                                                                            <input class="form-control" type="file" name="userfile[]" id="formFile" multiple >
                                                                        ...
                                                                        <!--                        <img data-dz-thumbnail class="img-fluid rounded d-block" src="<?=BASEURL?>assets/images/new-document.png" alt="Dropzone-Image" />-->
                                                                        <!--                    </div>-->
                                                                        <!--                </div>-->
                                                                ...
                                                                <div class="card border-animation qr-code my-div"  id="div2">
                                                                  ...
                                                                  <div class="card border-animation mt-4   trc-20-wallet my-div" id="div3" >
                                                            ...
                                                            <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?=$his['pay_mode']?></td>
                                                                        <!--<td><?=$his['user_id']?></td>-->
                                                                        <td><?php if($his['currency'] != ""){ echo $his['currency']; }else{ echo "USDT"; }?></td>
