...
<div class="container-fluid commission-container">
                     ...
                     <div class="row mt-1">
                        <div class="col-lg-12">
                            <div class="card m-withdraw-card">
                                <div class="card-header m-withdraw-card">
                                    <h5 class="card-title mb-0">Meta Withdraw History</h5>
                                </div>
                                <div class="card-body">
                                 ...
                                 <tbody>
                                   <?php $withdraw_his = $this->db->where('user_id',$this->session->userdata('usquareusername'))->order_by('withdraw_request_id', 'desc')->get('wallet_withdraw_request')->result_array();
                                   $count = 1;
                                   ...
                                   ?>  
                                    <tr>
                                       ...
                                       <td><?php if($wh['accepted_date'] == NULL){ echo "--";}else{echo  $wh['accepted_date'];}?></td>
                                       <td>
