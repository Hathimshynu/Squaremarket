                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card signin-card mt-0">
                            ...
                            <div class="card-body p-4 px-0 pb-0">
                                <div class="text-center mt-2">
                                    ...
                                    <p style="font-family: 'Barlow', sans-serif;" class="text-white">Sign-in to continue with Square Markets</p>
                                </div>
                                  <div>
                               <?php if($this->session->flashdata('success_message')){ ?>
                                ...
                                <div class="p-2 mt-4">
                                    <?=form_open_multipart('user/login'); ?>
                                        ...
                                        <div class="mb-3">
                                            <label style="font-family: 'Barlow', sans-serif;" for="username" class="form-label text-white">Email ID / CRM ID</label>
                                            <input type="text" class="form-control" id="email" name="email" value="" placeholder="Enter Email ID / CRM ID">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5 password-input" value="" name="password" placeholder="Enter password" id="password-input">
                        ...
                        <div class="mt-0 text-center">
                            <p class="mb-0"><span class="text-white">Don't have an account ?</span> <a style="color:#E1211F;font-weight:600; " href="<?=BASEURL?>admin/registration/live/" class="fw-semibold ms-1"> Sign Up </a> </p>
                        </div>
